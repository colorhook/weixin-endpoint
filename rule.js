...
module.exports = function(webot) {
    ...
    webot.set('/^吃+$/', '你是猪啊，就知道吃');

    webot.set('/^屁+$/', '你是傻鸟，鉴定完毕');
    ...
    webot.set('/^(你个|我)*(坏人|坏蛋|笨蛋|sb|二货|2货|傻x|大傻|瓜娃|小样|擦|你妹的?|算?(求|球|逑)|去|傻|傻鸟|煞笔|shabi|傻比|傻逼|神经|(神经|蛇精)病|深井冰|操|草|日|屮|艹)([\.!！。]*)$/i', ["你个傻X", "不许骂人", "你是神经病啊", "深井冰"]);
